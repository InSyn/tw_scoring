      ...
      <div class="competitorsPage__header">
        ...
        <div class="competitorsPage__header__actions">
          <v-btn
            ...
            class="competitorsPage__header__actions__button"
            color="var(--action-blue)"
            text
          >
            <v-icon
              class="competitorsPage__header__actions__button__icon"
      ...
      <div class="competitorsSheet__wrapper">
        <div class="competitorsSheet__header">
          <div
            ...
            :key="h"
            class="competitorsSheet__header__dataItem"
          >
            <v-btn
              @click="
            ...
            >
              ...
              <v-icon
                v-show="sortBy.title === head.id"
                class="competitorsSheet__header__dataItem__sortIcon"
                small
              >
                {{
        ...
        <div class="competitorsSheet__footer">
          ...
          <competitors-sheet-settings-dialog
            :competition="competition"
          ></competitors-sheet-settings-dialog>

          <clear-competitors-dialog
            :competition="competition"
          ></clear-competitors-dialog>
        </div>
      </div>
...
import CreateCompetitorDialog from "./dialogs/createCompetitor-dialog.vue";
import CompetitorsSheetSettingsDialog from "./dialogs/competitorsSheetSettings-dialog.vue";
import ClearCompetitorsDialog from "./dialogs/clearCompetitors-dialog.vue";
...
export default {
  ...
  mounted() {
    // if (
    //   this.competition &&
    //   !this.competition.competitorsSheet.competitors.length
    // )
    //   this.load_sheet({
    //     target: {
    //       files: [
    //         {
    //           path: "D:\\TW_Docs\\Competitions\\Season 2023-2024\\23-12-26 HP Sopka\\Старт-лист М.xlsx",
    //         },
    //       ],
    //     },
    //   });

    ...
    <div class="mainData__controlsGroup__wrapper">
      <div class="mainData__control__wrapper">
        <label class="mainData__label">
          ...
          <input class="mainData__input" type="text" :value="getCompetitionData.title.value"
      ...
      <div class="mainData__control__wrapper">
        <label class="mainData__label">
          ...
          <input class="mainData__input" type="text" :value="getCompetitionData.codex.value"
    ...
    <div class="mainData__controlsGroup__wrapper">
      <div class="mainData__control__wrapper">
        <label class="mainData__label">
          ...
          <select class="mainData__input" :value="getCompetitionData.discipline.value"
            @change="setDeepValue(competition.mainData, 'discipline.value', $event.target.value)">
            <option v-for="discipline in getSportDisciplines(event.sport)" :key="discipline.code"
              :value="discipline.name_rus">
              {{ discipline.name_rus }}
            </option>
          </select>
        </label>
      ...
      <div class="mainData__control__wrapper">
        <label class="mainData__label">
          ...
          <select class="mainData__input" :value="getCompetitionData.title.stage.value.value"
    ...
    <div class="mainData__controlsGroup__wrapper">
      <div class="mainData__control__wrapper">
        <label class="mainData__label">
          ...
          <select class="mainData__input" :value="getCompetitionData.title.stage.group"
      ...
      <div class="mainData__control__wrapper">
        <label class="mainData__label">
          ...
          <select class="mainData__input" :value="getCompetitionData.group.value"
    ...
    <div class="mainData__controlsGroup__wrapper">
      <div class="mainData__control__wrapper" data-type="country">
        <label class="mainData__label">
          ...
          <select class="mainData__input" :value="getCompetitionData.country.value"
      ...
      <div class="mainData__control__wrapper">
        <label class="mainData__label">
          ...
          <input class="mainData__input" type="text" :value="getCompetitionData.location.value"
    ...
    <div class="mainData__controlsGroup__wrapper">
      <div class="mainData__control__wrapper">
        <label class="mainData__label">
          ...
          <input class="mainData__input" type="text" :value="getCompetitionData.provider.value"
      ...
      <div class="mainData__control__wrapper">
        <label class="mainData__label">
          ...
          <input class="mainData__input" type="text" :value="getCompetitionData.providerTiming.value"

    ...
    >
            ...
            <div style="display: flex; align-items: center; padding: 4px 8px">
              ...
              <div v-else class="classicMarks__wrapper ml-auto">
                <input
                  ...
                  "
                />
                <v-icon small style="margin: 0 4px" color="var(--text-default)"
                  >mdi-arrow-right
                </v-icon>
                <input
                  type="text"
      ...
      <v-card-actions
        style="
          ...
          border-top: 1px solid var(--standard-background);
        "
      >
        <v-btn
...
export default {
  ...
  methods: {
    ...
    checkTie(competitor) {
      const competitorResult = competitor.results_overall.find(
        ...
        (tieCheckCompetitor) => {
          ...
          return tieCheckCompetitor.results_overall.some(
            (overallResult) =>
              ...
              overallResult.value === competitorResult.value
          );
        }
      );
    },

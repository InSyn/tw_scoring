  ...
  <v-col class="pa-2" cols="8">
    ...
    >
      <div
        ...
        :key="cor_idx"
        style="flex: 1 0 auto; display:flex;flex-wrap: wrap;align-items: center;"
      >
        <div
          v-if="compById(du_competitors[cor_idx])"
          style="display:flex;align-items:center;width: 100%;font-size: 1.2rem;font-weight:bold;"
        >
          {{
        ...
        >
          <div
            ...
            style="display:flex;align-items: center;font-weight:bold;margin-right: 1rem"
          >
            <div>{{ judge.title }}</div>
            <div
              style="margin-left: .5rem;padding: 4px .5rem;min-width: 3rem;border-radius: 6px"
              :style="{
                backgroundColor:

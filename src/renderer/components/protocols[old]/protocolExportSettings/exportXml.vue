<template>
  ...
  >
    ...
    <div class="xml_export_actions" style="margin-top: auto; display: flex; align-items: center; justify-content: flex-end">
      <v-btn
        small
        depressed
      ...
      >
        <v-icon :color="$vuetify.theme.themes[appTheme].textDefault" style="margin-right: 0.5rem">mdi-download</v-icon>
                ...
                ...this.$store.getters['main/flatGrid']
                  ...
                  .map((_competitor) => {
                    return {
                      ...
                      Competitor: {
                        Fiscode: _competitor.competitor.info_data['fiscode'] || '',
                        Lastname: _competitor.competitor.info_data['lastname'] || '',
                        Firstname: _competitor.competitor.info_data['name'] || '',
                        Sex: this.competition.mainData.title.stage.group,
                        Nation: _competitor.competitor.info_data['nation'] || '',
                        Yearofbirth: _competitor.competitor.info_data['year'] || '',
                      },
                      [`${this.type}_result`]: {

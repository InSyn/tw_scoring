<template>
  <div class="protocolAdditionalSettings__container">
    ...
    <div>
      <label for="notations" class="ma-1 font-weight-bold"
        >{{ localization[lang].app.protocols.notations }}
      </label>
      <div
        style="border-radius: 6px; background-color: var(--standard-background)"
      >
        <textarea
          id="notations"

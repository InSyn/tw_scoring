<template>
  <div v-if="competition" class="protocolsMainPage__container">
    ...
    <div class="protocolsSettings__wrapper" style>
    ...
    <div
      ...
      class="protocolPreview__wrapper"
    >
      <v-btn
        @click="competition.protocol_settings.show_preview = false"
        class="protocolPreview__button-close"
      ...
      <race_results_protocol
        v-if="competition.protocol_settings.result_protocols.race_filter"
      ></race_results_protocol>

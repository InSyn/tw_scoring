...
//     let marksArray = [];
//
//     if (marks === undefined || !marks.length) return;
//     marks.forEach((markPackage) => {
//       markPackage[0] !== undefined && marksArray.push(parseInt(markPackage[0]));
//       markPackage[1] !== undefined && markPackage[1].forEach((mark) => mark.forEach((score) => marksArray.push(parseInt(score))));
//     });
//
//     const dataPackage = [
//       'chief_judge',
